...
- ✅ **ip route 10.10.0.0 255.255.0.0 209.165.200.225 100** _(Correct Answer)_
...
- ✅ **Change the destination network and mask to 0.0.0.0 0.0.0.0** _(Correct Answer)_
...
- ✅ **ipv6 route 2001:db8:12:10::/64 S0/0/1 fe80::2** _(Correct Answer)_
...
- ✅ **introducing a rogue switch and enabling trunking** _(Correct Answer)_
...
- VLAN hopping
- DHCP spoofing
- ✅ **MAC address table overflow** _(Correct Answer)_
- VLAN double-tagging
...
![Question 8 Exhibit](images/answers/answer_image_1.png)
...
- ✅ **The state is not maintained by the DHCPv6 server under stateless DHCPv6 operation.** _(Correct Answer)_
...
- ✅ **the virtual IP address and the virtual MAC address for the HSRP group 1** _(Correct Answer)_
...
- ✅ **Frame forwarding decisions are based on MAC address and port mappings in the CAM table.** _(Correct Answer)_
...
- ✅ **The broadcast domain expands to all switches.** _(Correct Answer)_
...
![Question 13 Exhibit](images/answers/answer_image_2.png)
...
- ✅ **SW1 floods the frame on all ports on SW1, excluding the port through which the frame entered the switch.** _(Correct Answer)_
...
- ✅ **Because these VLANs are stored in a file that is called vlan.dat that is located in flash memory, this file must be manually deleted.** _(Correct Answer)_
...
![Question 17 Exhibit](images/answers/answer_image_3.png)


**Options:**

- ✅ **STP will block one of the redundant links.** _(Correct Answer)_
...
- Configure 802.1x.
- ✅ **Configure SSH.** _(Correct Answer)_
- Configure Telnet.
...
- ✅ **WPA2 with AES** _(Correct Answer)_
- WPA2 with TKIP
- WEP
- WPA
...
- firewall appliance
- ✅ **wireless router** _(Correct Answer)_
- switch
...
Source IP: 10.1.1.10** _(Correct Answer)_
...
- ✅ **Packets with a destination network that is not 10.10.0.0/16 or is not 10.20.0.0/16 or is not a directly connected network will be forwarded to the Internet.** _(Correct Answer)_
...
- ✅ **because VLAN 99 has not yet been created** _(Correct Answer)_
...
- distribution
- slave
- ✅ **server** _(Correct Answer)_
- ✅ **transparent** _(Correct Answer)_
...
- ✅ **Configure the switch with the name of the new management domain.** _(Correct Answer)_
...
- ✅ **Select the correct VTP mode and version.** _(Correct Answer)_
- ✅ **Reboot the switch.** _(Correct Answer)_
...
- ✅ **Link types are determined automatically.** _(Correct Answer)_
...
- fa0/9
- ✅ **fa0/13** _(Correct Answer)_
- ✅ **fa0/10** _(Correct Answer)_
- fa0/20
- ✅ **fa0/21** _(Correct Answer)_
- fa0/11
...
- ✅ **Ethernet multiaccess interfaces will require fully specified static routes to avoid routing inconsistencies.** _(Correct Answer)_
...
- ✅ **They improve netw​ork security.** _(Correct Answer)_
...
- ✅ **They use fewer router resources.** _(Correct Answer)_
...
- ✅ **S 10.17.2.0/24 [1/0] via 10.16.2.2** _(Correct Answer)_
...
- ✅ **It enables portfast on a specific switch interface.** _(Correct Answer)_
...
- ✅ **In a switched network, they are mostly configured between switches at the core and distribution layers.** _(Correct Answer)_
...
- ✅ **They are not associated with a particular VLAN.** _(Correct Answer)_
...
- ✅ **The allowed VLANs on the backup link were not configured correctly.** _(Correct Answer)_
...
- ✅ **interface range GigabitEthernet 0/4 – 5** _(Correct Answer)_
...
- ✅ **The switch will forward the frame out all ports except the incoming port.** _(Correct Answer)_
...
- ✅ **Check the configuration of the exit interface on the new static route.** _(Correct Answer)_
...
- ✅ **auto** _(Correct Answer)_
- default
- passive
- ✅ **desirable** _(Correct Answer)_
- extended
- ✅ **on** _(Correct Answer)_
...
- ✅ **Remove the route using the no ip route command.** _(Correct Answer)_
...
- ✅ **R1 is configured as a DHCPv4 relay agent.** _(Correct Answer)_
...
![Question 43 Exhibit](images/answers/answer_image_4.png)
...
- ✅ **The ip helper-address command was applied on the wrong interface.** _(Correct Answer)_
...
![Question 45 Exhibit](images/answers/answer_image_5.png)


**Options:**

- ✅ **The SSID is broadcast.** _(Correct Answer)_
- MAC address filtering is enabled.
- WEP encryption is enabled.
- The wireless channel is automatically selected.
- ✅ **A well-known administrator password is set.** _(Correct Answer)_
...
- ✅ **to reduce outsiders intercepting data or accessing the wireless network by using a well-known address range** _(Correct Answer)_
...
- ✅ **frame translation to other protocols** _(Correct Answer)_
- ✅ **association and re-association of roaming clients** _(Correct Answer)_
...
- ✅ **all PortFast-enabled ports** _(Correct Answer)_
...
- ✅ **rogue switches on a network** _(Correct Answer)_
...
- ✅ **It uses the MAC-address-to-IP-address binding database to validate an ARP packet.** _(Correct Answer)_

**Explanation:**

DAI relies on DHCP snooping. DHCP snooping listens to DHCP message exchanges and builds a bindings database of valid tuples (MAC address, IP address, VLAN interface). When DAI is enabled, the switch drops ARP packet if the sender MAC address and sender IP address do not match an entry in the DHCP snooping bindings database. However, it can be overcome through static mappings. Static mappings are useful when hosts configure static IP addresses, DHCP snooping cannot be run, or other switches in the network do not run dynamic ARP inspection. A static mapping associates an IP address to a MAC address on a VLAN.
...
![Question 53 Exhibit](images/answers/answer_image_6.png)


**Options:**

- ✅ **Change the administrative distance to 120.** _(Correct Answer)_
...
![Question 54 Exhibit](images/answers/answer_image_7.png)
...
- ✅ **IP address** _(Correct Answer)_
- VTP domain
- ✅ **vty lines** _(Correct Answer)_
- default VLAN
- ✅ **default gateway** _(Correct Answer)_
- loopback address
...
![Question 56 Exhibit](images/answers/answer_image_8.png)


**Options:**

- ✅ **ipv6 nd other-config-flag​** _(Correct Answer)_
...
(config-if)# ip address 192.168.1.2 255.255.255.252** _(Correct Answer)_
- (config)# interface vlan 1
(config-if)# ip address 192.168.1.2 255.255.255.0
(config-if)# no shutdown
- ✅ **(config)# ip routing** _(Correct Answer)_
...
- ✅ **Configure the 5 GHz band for streaming multimedia and time sensitive traffic.** _(Correct Answer)_
- Configure the security mode to WPA Personal TKIP/AES for one network and WPA2 Personal AES for the other network
- ✅ **Configure the 2.4 GHz band for basic internet traffic that is not time sensitive.** _(Correct Answer)_
...
- Check the configuration on the floating static route and adjust the AD.
- ✅ **Ensure that the old default route has been removed from the company edge routers.** _(Correct Answer)_
- Create a floating static route to that network.
...
- ✅ **the source MAC address and the incoming port** _(Correct Answer)_
...
![Question 61 Exhibit](images/answers/answer_image_9.png)


**Options:**

- ✅ **PAgP** _(Correct Answer)_
- DTP
- LACP
- STP
...
- ✅ **floating static route** _(Correct Answer)_
...
- ✅ **The switch forwards the frame out of the specified port.** _(Correct Answer)_
...
![Question 64 Exhibit](images/answers/answer_image_10.png)
...
- ✅ **R2(config)# ip route 172.16.2.0 255.255.255.0 172.16.3.1** _(Correct Answer)_
...
- ✅ **EtherChannel** _(Correct Answer)_
- DTP
- STP
- VTP
...
![Question 66 Exhibit](images/answers/answer_image_11.png)


**Options:**

- host B
- ✅ **host C** _(Correct Answer)_
- ✅ **host D** _(Correct Answer)_
- host E
- ✅ **host F** _(Correct Answer)_
- host G
...
![Question 67 Exhibit](images/answers/answer_image_12.png)


**Options:**

- Associate hosts A and B with VLAN 10 instead of VLAN 1.
- ✅ **Configure either trunk port in the dynamic desirable mode.** _(Correct Answer)_
...
- ✅ **It disables an unused port.** _(Correct Answer)_
...
- ✅ **so that the attacker can see frames that are destined for other hosts** _(Correct Answer)_
...
- ✅ **Immediately after successful authentication against an AAA data source** _(Correct Answer)_
...
- ✅ **sticky secure MAC addresses** _(Correct Answer)_
...
- 802.11a
- ✅ **802.11b** _(Correct Answer)_
- ✅ **802.11g** _(Correct Answer)_
- ✅ **802.11n** _(Correct Answer)_
- 802.11ac
...
- ✅ **The root bridge BID.** _(Correct Answer)_
- ✅ **The role of the ports in all VLANs.** _(Correct Answer)_
...
![Question 74 Exhibit](images/answers/answer_image_13.png)


**Options:**

- Trunk1
- ✅ **Trunk2** _(Correct Answer)_
- Trunk3
- Trunk4
...
- SSH
- SNMP
- ✅ **TACACS+** _(Correct Answer)_
- ✅ **RADIUS** _(Correct Answer)_
...
- ✅ **to eliminate outsiders scanning for available SSIDs in the area** _(Correct Answer)_
- to reduce the risk of interference by external devices such as microwave ovens
...
- ✅ **turning on DHCP snooping** _(Correct Answer)_
...
![Question 81 Exhibit](images/answers/answer_image_14.png)


**Options:**

- There is no address on Fa0/0 to use as a default gateway.
- ✅ **RTA is using the same subnet for VLAN 20 and VLAN 30.** _(Correct Answer)_
...
- access - trunk
- ✅ **dynamic desirable - trunk** _(Correct Answer)_
- access - dynamic auto
- ✅ **dynamic desirable - dynamic desirable** _(Correct Answer)_
- ✅ **dynamic desirable - dynamic auto** _(Correct Answer)_
...
- Verify that there is not a default route in any of the edge router routing tables.
- ✅ **Create static routes to all internal networks and a default route to the internet.** _(Correct Answer)_
...
- channels 1, 5, and 9
- ✅ **channels 1, 6, and 11** _(Correct Answer)_
- channels 1, 7, and 13
- channels 2, 6, and 10
...
- ✅ **a key that matches the key on the AP** _(Correct Answer)_
- a user passphrase
...
![Question 86 Exhibit](images/answers/answer_image_15.png)


**Options:**

- ✅ **alternate, designated, root, root** _(Correct Answer)_
...
![Question 87 Exhibit](images/answers/answer_image_16.png)


**Options:**

- ip route 172.16.1.0 255.255.255.0 s0/0/0
- ✅ **ip route 172.16.1.0 255.255.255.0 s0/0/0 121** _(Correct Answer)_
...
- Disable DTP.
- Disable STP.
- ✅ **Enable port security.** _(Correct Answer)_
...
- ✅ **The 5 GHz band has more channels and is less crowded than the 2.4 GHz band, which makes it more suited to streaming multimedia.** _(Correct Answer)_
...
- broadcast DHCPACK
- ✅ **broadcast DHCPREQUEST** _(Correct Answer)_
- unicast DHCPACK
- unicast DHCPREQUEST
...
- ✅ **MAC address of the virtual router** _(Correct Answer)_
...
- ✅ **The host sends an ICMPv6 neighbor solicitation message to the DHCP or SLAAC-learned address and if no neighbor advertisement is returned, the address is considered unique.** _(Correct Answer)_
...
![Question 93 Exhibit](images/answers/answer_image_17.png)
...
![Question 95 Exhibit](images/answers/answer_image_18.png)
...
- ✅ **The encapsulation dot1Q 5 command contains the wrong VLAN.** _(Correct Answer)_
...
![Question 96 Exhibit](images/answers/answer_image_19.png)


**Options:**

- It identifies the subinterface.
- ✅ **It identifies the VLAN number.** _(Correct Answer)_
...
- IP address spoofing
- ✅ **DHCP starvation** _(Correct Answer)_
- CAM table attack
- DHCP spoofing
...
- ✅ **The IP address of the default gateway router is not contained in the excluded address list.** _(Correct Answer)_
...
- ✅ **R1(config-if)# ip helper-address 10.2.0.250** _(Correct Answer)_
- R1(config)# interface G0/1
- ✅ **R1(config)# interface G0/0** _(Correct Answer)_
...
- ✅ **to enhance user bandwidth** _(Correct Answer)_
- to create more broadcast domains
- to eliminate virtual circuits
- ✅ **to isolate traffic between segments** _(Correct Answer)_
...
- ✅ **the ipv6 unicast-routing command** _(Correct Answer)_
...
- ✅ **Configure the port as an 802.1q trunk port.** _(Correct Answer)_
...
- Use private VLANs.
- Enable BPDU guard.
- ✅ **Enable trunking manually** _(Correct Answer)_
- Enable Source Guard.
- ✅ **Disable DTP.** _(Correct Answer)_
- ✅ **Set the native VLAN to an unused VLAN.** _(Correct Answer)_
...
![Question 108 Exhibit](images/answers/answer_image_20.png)
...
- ✅ **when packets are being dropped from a particular directly attached host** _(Correct Answer)_
...
- ✅ **User accounts must be configured locally on each device, which is an unscalable authentication solution.** _(Correct Answer)_
...
- ✅ **It sends a DHCPREQUEST that identifies which lease offer the client is accepting.** _(Correct Answer)_
...
- ✅ **This port is currently up.** _(Correct Answer)_
- The port is configured as a trunk link.
- ✅ **Security violations will cause this port to shut down immediately.** _(Correct Answer)_
- There is no device currently connected to this port.
- ✅ **The switch port mode for this interface is access mode.** _(Correct Answer)_
...
- WPA Personal
- WPA2 Personal
- ✅ **WPA2 Enterprise** _(Correct Answer)_
...
- ✅ **The VLANs for user access ports should be different VLANs than any native VLANs used on trunk ports.** _(Correct Answer)_
...
![Question 115 Exhibit](images/answers/answer_image_21.png)


**Options:**

- ✅ **The EtherChannel is down.** _(Correct Answer)_
- ✅ **The port channel ID is 2.** _(Correct Answer)_
...
![Question 116 Exhibit](images/answers/answer_image_22.png)
...
![Question 118 Exhibit](images/answers/answer_image_23.png)
...
- ✅ **ipv6 route ::/0 serial 0/1/1** _(Correct Answer)_
...
- Verify that there is not a default route in any of the edge router routing tables.
- Create a floating static route to that network.
- ✅ **Check the statistics on the default route for oversaturation.** _(Correct Answer)_
...
- The switch purges the entire MAC address table.
- ✅ **The switch replaces the old entry and uses the more current port.** _(Correct Answer)_
- The switch updates the refresh timer for the entry.
- The switch forwards the frame out of the specified port.
...
- to provide privacy and integrity to wireless traffic by using encryption
- ✅ **to facilitate group configuration and management of multiple WLANs through a WLC** _(Correct Answer)_
...
- ✅ **creating SVI interfaces** _(Correct Answer)_
- adjusting the route metric
- ✅ **enabling IP routing** _(Correct Answer)_
- ✅ **assigning ports to VLANs** _(Correct Answer)_
- deleting the default VLAN
- assigning the ports to the native VLAN
- modifying the default VLAN
- ✅ **Case 1:** _(Correct Answer)_
- installing a static route
- assigning the ports to the native VLAN
- ✅ **entering “no switchport” on the port connected to the router** _(Correct Answer)_
- modifying the default VLAN
- ✅ **assigning ports to VLANs** _(Correct Answer)_
- ✅ **enabling IP routing** _(Correct Answer)_
- adjusting the route metric
- ✅ **Case 2:** _(Correct Answer)_
...
- ✅ **creating SVI interfaces** _(Correct Answer)_
- installing a static route
- ✅ **creating VLANs** _(Correct Answer)_
- ✅ **Case 3:** _(Correct Answer)_
- ✅ **assigning ports to VLANs** _(Correct Answer)_
- assigning the ports to the native VLAN
- modifying the default VLAN
- deleting the default VLAN
...
Step 5. Verify connectivity. Reference: 4.3.8 Packet Tracer Configure Layer 3 Switching and inter VLAN Routing
...
- ✅ **An autonegotiation failure can result in connectivity issues.** _(Correct Answer)_
- ✅ **When the speed is set to 1000 Mb/s, the switch ports will operate in full-duplex mode.** _(Correct Answer)_
- ✅ **The duplex and speed settings of each switch port can be manually configured.** _(Correct Answer)_
...
![Question 124 Exhibit](images/answers/answer_image_24.png)


**Options:**

- A. The port Gi0/0 should be configured as trunk port.
- ✅ **B. The encapsulation is misconfigured on a subinterface.** _(Correct Answer)_
...
- ✅ **PortFast is not configured on all access ports.** _(Correct Answer)_
...
![Question 127 Exhibit](images/answers/answer_image_25.png)


**Options:**

- ✅ **stateful** _(Correct Answer)_
- stateless
...
- ✅ **Although DTLS is enabled by default to secure the CAPWAP control channel, it is disabled by default for the data channel.** _(Correct Answer)_
...
- ✅ **Configure the new switch as a VTP client.** _(Correct Answer)_
- ✅ **Configure the existing VTP domain name on the new switch.** _(Correct Answer)_
...
![Question 130 Exhibit](images/answers/answer_image_26.png)


**Options:**

- ✅ **to Fa0/1, Fa0/2, and Fa0/3 only** _(Correct Answer)_
...
- ✅ **The switch adds the MAC address and incoming port number to the table.** _(Correct Answer)_
- The switch adds a MAC address table entry mapping for the destination MAC address and the ingress port.
- ✅ **Case 2:** _(Correct Answer)_
...
- ✅ **Use the “show ip interface brief” command to see if an interface is down.** _(Correct Answer)_
- Verify that there is not a default route in any of the edge router routing tables.
- Create static routes to all internal networks and a default route to the internet.
- Check the statistics on the default route for oversaturation.
...
- ✅ **It enables DHCP snooping globally on a switch.** _(Correct Answer)_
...
- Create extra static routes to the same location with an AD of 1.
- Check the statistics on the default route for oversaturation.
- ✅ **Check the routing table for a missing static route.** _(Correct Answer)_
...
- ✅ **fast internal switching** _(Correct Answer)_
- ✅ **large frame buffers** _(Correct Answer)_
...
- ✅ **The size of the broadcast domain is increased.** _(Correct Answer)_
...
- ✅ **It enables port security on an interface.** _(Correct Answer)_
...
![Question 141 Exhibit](images/answers/answer_image_27.png)
...
- to centralize management of multiple WLANs
- ✅ **to restrict access to the WLAN by authorized, authenticated users only** _(Correct Answer)_
...
- It manually enables a trunk link.
- It disables an unused port.
- ✅ **It disables DTP on a non-trunking interface.** _(Correct Answer)_
...
- ✅ **The dns-server line is included in the ipv6 dhcp pool section.** _(Correct Answer)_
- ✅ **The ipv6 nd other-config-flag is entered for the interface that faces the LAN segment.** _(Correct Answer)_
...
- ✅ **The interface is incorrect.** _(Correct Answer)_
...
- ✅ **It enables DAI on specific switch interfaces previously configured with DHCP snooping.** _(Correct Answer)_
...
- to centralize management of multiple WLANs
- to provide prioritized service for time-sensitive applications
- ✅ **to provide privacy and integrity to wireless traffic by using encryption** _(Correct Answer)_
...
- ✅ **Verify that the static route to the server is present in the routing table.** _(Correct Answer)_
- Check the configuration on the floating static route and adjust the AD.
- Create a floating static route to that network.
...
- It enables port security globally on the switch.
- ✅ **It restricts the number of discovery messages, per second, to be received on the interface.** _(Correct Answer)_
- It dynamically learns the L2 address and copies it to the running configuration.
...
- ✅ **It checks the source L2 address in the Ethernet header against the sender L2 address in the ARP body.** _(Correct Answer)_
- It disables all trunk ports.
- It displays the IP-to-MAC address associations for switch interfaces.
- It enables portfast on a specific switch interface.
...
- ✅ **This is the fastest forwarding mechanism on Cisco routers and multilayer switches.** _(Correct Answer)_
...
- ✅ **Packets are forwarded based on information in the FIB and an adjacency table.** _(Correct Answer)_
...
- agent
- supplicant
- ✅ **authenticator** _(Correct Answer)_
...
- ✅ **Dynamic ARP Inspection** _(Correct Answer)_
- IP Source Guard
- DHCP Snooping
- Port Security
...
- ✅ **PVST+ optimizes performance on the network through load sharing.** _(Correct Answer)_
...
- It checks the source L2 address in the Ethernet header against the sender L2 address in the ARP body.
- It restricts the number of discovery messages, per second, to be received on the interface.
- ✅ **It displays the IP-to-MAC address associations for switch interfaces.** _(Correct Answer)_
...
- The switch forwards the frame out of the specified port.
- ✅ **The switch updates the refresh timer for the entry.** _(Correct Answer)_
- The switch replaces the old entry and uses the more current port.
- The switch adds a MAC address table entry for the destination MAC address and the egress port.
...
- ✅ **Segment the LAN into smaller LANs and route between them.*** _(Correct Answer)_
...
- ✅ **An IPv4 static host route configuration uses a destination IP address of a specific device and a /32 subnet mask.** _(Correct Answer)_
...
- ✅ **interface number and type** _(Correct Answer)_
...
- ✅ **personal** _(Correct Answer)_
- AES
- TKIP
- WEP
- ✅ **enterprise** _(Correct Answer)_
...
- ✅ **enabling DHCPv6 Guard** _(Correct Answer)_
- enabling RA Guard
- implementing port security on edge ports
- disabling CDP on edge ports
...
- ✅ **prefix length** _(Correct Answer)_
- subnet mask in dotted decimal notation
- domain name
- administrative distance
- ✅ **prefix** _(Correct Answer)_
...
- ✅ **extended system ID** _(Correct Answer)_
- cost
- IP address
- ✅ **bridge priority** _(Correct Answer)_
- ✅ **MAC address** _(Correct Answer)_
- port ID
